 ...
 * 4. Check if any 3 (or more) adjacent points in the sorted order have equal slopes with respect to
 * p.
 * If so, these points, together with p, are collinear.
 * Applying this method for each of the n points in turn.
 * The algorithm solves the problem because points that have equal slopes with respect to p are
 * collinear,
...
public class test {
     ...
     * read the input file; prints to standard output the line segments that your program discovers,
     * one per line;
